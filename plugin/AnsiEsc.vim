...
"  call Dfunc("AnsiEsc#AnsiEsc()")
  ...
  " ---------------------------------------------------------------------
  syn region ansiBlackBlack	 start="\e\[\%([0-4];\)*30;40\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiRedBlack	 start="\e\[\%([0-4];\)*31;40\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiGreenBlack	 start="\e\[\%([0-4];\)*32;40\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiYellowBlack	 start="\e\[\%([0-4];\)*33;40\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiBlueBlack	 start="\e\[\%([0-4];\)*34;40\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiMagentaBlack	 start="\e\[\%([0-4];\)*35;40\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiCyanBlack	 start="\e\[\%([0-4];\)*36;40\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiWhiteBlack	 start="\e\[\%([0-4];\)*37;40\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
                                                            
  syn region ansiBlackRed	 start="\e\[\%([0-4];\)*30;41\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiRedRed		 start="\e\[\%([0-4];\)*31;41\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiGreenRed	 start="\e\[\%([0-4];\)*32;41\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiYellowRed	 start="\e\[\%([0-4];\)*33;41\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiBlueRed	 start="\e\[\%([0-4];\)*34;41\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiMagentaRed	 start="\e\[\%([0-4];\)*35;41\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiCyanRed	 start="\e\[\%([0-4];\)*36;41\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiWhiteRed	 start="\e\[\%([0-4];\)*37;41\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
                                                            
  syn region ansiBlackGreen	 start="\e\[\%([0-4];\)*30;42\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiRedGreen	 start="\e\[\%([0-4];\)*31;42\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiGreenGreen	 start="\e\[\%([0-4];\)*32;42\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiYellowGreen	 start="\e\[\%([0-4];\)*33;42\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiBlueGreen	 start="\e\[\%([0-4];\)*34;42\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiMagentaGreen	 start="\e\[\%([0-4];\)*35;42\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiCyanGreen	 start="\e\[\%([0-4];\)*36;42\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiWhiteGreen	 start="\e\[\%([0-4];\)*37;42\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
                                                            
  syn region ansiBlackYellow	 start="\e\[\%([0-4];\)*30;43\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiRedYellow	 start="\e\[\%([0-4];\)*31;43\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiGreenYellow	 start="\e\[\%([0-4];\)*32;43\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiYellowYellow	 start="\e\[\%([0-4];\)*33;43\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiBlueYellow	 start="\e\[\%([0-4];\)*34;43\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiMagentaYellow	 start="\e\[\%([0-4];\)*35;43\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiCyanYellow	 start="\e\[\%([0-4];\)*36;43\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiWhiteYellow	 start="\e\[\%([0-4];\)*37;43\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
                                                            
  syn region ansiBlackBlue	 start="\e\[\%([0-4];\)*30;44\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiRedBlue	 start="\e\[\%([0-4];\)*31;44\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiGreenBlue	 start="\e\[\%([0-4];\)*32;44\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiYellowBlue	 start="\e\[\%([0-4];\)*33;44\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiBlueBlue	 start="\e\[\%([0-4];\)*34;44\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiMagentaBlue	 start="\e\[\%([0-4];\)*35;44\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiCyanBlue	 start="\e\[\%([0-4];\)*36;44\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiWhiteBlue	 start="\e\[\%([0-4];\)*37;44\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
                                                            
  syn region ansiBlackMagenta	 start="\e\[\%([0-4];\)*30;45\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiRedMagenta	 start="\e\[\%([0-4];\)*31;45\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiGreenMagenta	 start="\e\[\%([0-4];\)*32;45\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiYellowMagenta	 start="\e\[\%([0-4];\)*33;45\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiBlueMagenta	 start="\e\[\%([0-4];\)*34;45\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiMagentaMagenta	 start="\e\[\%([0-4];\)*35;45\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiCyanMagenta	 start="\e\[\%([0-4];\)*36;45\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiWhiteMagenta	 start="\e\[\%([0-4];\)*37;45\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
                                                            
  syn region ansiBlackCyan	 start="\e\[\%([0-4];\)*30;46\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiRedCyan	 start="\e\[\%([0-4];\)*31;46\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiGreenCyan	 start="\e\[\%([0-4];\)*32;46\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiYellowCyan	 start="\e\[\%([0-4];\)*33;46\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiBlueCyan	 start="\e\[\%([0-4];\)*34;46\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiMagentaCyan	 start="\e\[\%([0-4];\)*35;46\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiCyanCyan	 start="\e\[\%([0-4];\)*36;46\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiWhiteCyan	 start="\e\[\%([0-4];\)*37;46\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
                                                            
  syn region ansiBlackWhite	 start="\e\[\%([0-4];\)*30;47\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiRedWhite	 start="\e\[\%([0-4];\)*31;47\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiGreenWhite	 start="\e\[\%([0-4];\)*32;47\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiYellowWhite	 start="\e\[\%([0-4];\)*33;47\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiBlueWhite	 start="\e\[\%([0-4];\)*34;47\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiMagentaWhite	 start="\e\[\%([0-4];\)*35;47\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiCyanWhite	 start="\e\[\%([0-4];\)*36;47\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
  syn region ansiWhiteWhite	 start="\e\[\%([0-4];\)*37;47\%(;[0-4]\)*m" end="\e\["me=e-2 contains=ansiConceal
