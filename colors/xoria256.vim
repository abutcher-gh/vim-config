...
hi SpellBad     ctermfg=174 guifg=#1c1c1c guisp=Red   term=bold cterm=bold,underline gui=undercurl
hi SpellCap     ctermfg=32  guifg=#dfdfff guisp=Blue  term=bold cterm=bold,underline gui=undercurl
